...
\label{fig:spectrum}
%\script{compute_if.py} % needs pip installable pylanetary...
\end{figure}
...
\caption{Results of the false positive rate experiment for Kp band. See caption of Figure \ref{fig:randomstack} for a description. \label{fig:randomstack_K}}
\end{figure}
